...
public class FinallyBlock {
	...
	// finally -- Whatever the code we have return inside the finally block it will
	// be executed.
	
	// Note - If we try to return anything in try/catch block even though exception
	// is coming or not , it will only return the value in the finally block.
